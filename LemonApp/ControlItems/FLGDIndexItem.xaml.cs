    ...
    public partial class FLGDIndexItem : UserControl
    {
        ...
        public FLGDIndexItem(MusicGD dat, bool hasDeleteBtn = false, string subtitle = "")
        {
            ...
            if (data.Source == Plantform.qq)
            {
                if (!hasDeleteBtn)
                {
                    string Buttonsxaml = "<Border " + AppConstants.XAMLUSINGS + @" x:Name=""StarBtn"" Height=""25"" VerticalAlignment=""Top"" HorizontalAlignment=""Left"" Width=""25"" Background=""#CC000000"" Visibility=""Collapsed"" CornerRadius=""25"" Margin=""35,5,0,0"">
            <Path Data=""M1003.2,400.32A49.408,49.408,0,0,0,985.728,386.496A42.88,42.88,0,0,0,968.128,379.456L669.632,337.152 550.4,64.256A44.928,44.928,0,0,0,506.624,38.336A44.992,44.992,0,0,0,462.784,64.256L343.744,336.768 49.408,378.496A44.928,44.928,0,0,0,12.672,413.696A44.992,44.992,0,0,0,25.984,462.848L251.84,646.784 165.888,924.544A44.864,44.864,0,0,0,182.016,972.672A44.8,44.8,0,0,0,232.256,981.632L513.28,846.976 785.856,977.6A44.8,44.8,0,0,0,836.096,968.704A44.8,44.8,0,0,0,852.224,920.512L766.72,644.096 997.056,465.792C1016.64,450.56,1019.328,421.248,1003.2,400.32z"" Fill=""White"" Stretch=""Uniform"" Margin=""6""/>
                ...
                {
                    string Buttonsxaml = "<Border " + AppConstants.XAMLUSINGS + @" x:Name=""DeleteBtn"" Height=""25"" VerticalAlignment=""Top"" HorizontalAlignment=""Left"" Width=""25"" Background=""#CC000000"" CornerRadius=""25"" Visibility=""Collapsed"" Margin=""35,5,0,0"">
            ...
            {
                string Buttonsxaml = "<Border "+ AppConstants.XAMLUSINGS + " x:Name=\"BindingToNetease\" HorizontalAlignment=\"Right\" Height=\"20\" VerticalAlignment=\"Top\" Width=\"20\" CornerRadius=\"25,25,25,25\" Background=\"#FFE12123\" Margin=\"8\">\r\n            <Path Data=\"{StaticResource NeteaseIcon}\" Fill=\"White\" Stretch=\"Uniform\" Margin=\"5\"/>\r\n        </Border>";
                var Sign_NE = (Border)XamlReader.Parse(Buttonsxaml);
                grid.Children.Add(Sign_NE);
            }
